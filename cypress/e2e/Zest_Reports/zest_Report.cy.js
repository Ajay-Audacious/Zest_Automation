...
describe("Login Test", () => {
  ...
  describe("Reports Module Test", () => {
    ...
    it.only("Creation Report & ", () => {
      cy.get("#add_report").click();
      const startTime = "09:30:AM";
      const endTime = "6:30:PM";
      cy.get("#start_date_0").click().type(startTime);
      cy.get('.ant-picker-time-panel-cell-selected').click();
      ...
      cy.get("#description_0").type("Something text as per the details");
